    ...
    <section class="concon">
        <div class="sidebar bg-dark">
            <ul class="sidebar-lists ps-0">
                ...
                <li class="sidebar-item">
                    <a href="./recent.php" class="text-decoration-none text-secondary sidebar-link active" id="recent_sidebar"><i class="fa-regular fa-clock me-2"></i>Recently Played</a>
                </li>
                <li class="sidebar-item">
                ...
                <div class="favorite_lists">
                    <div class="eachSong active">
                        <div class="each_left">
                            ...
                            <img src="./assets/image/selenawolves.jpg" alt="" class="cover_track_photo">
                            <div class="track_infomation">
                                <h5 class="each_track_title mb-0">Wolves</h5>
                                <small class="each_artist">Selena Gomez</small>
                            </div>
                        </div>
